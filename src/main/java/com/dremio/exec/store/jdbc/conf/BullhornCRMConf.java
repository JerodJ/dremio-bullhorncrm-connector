...
@SourceType(value = "BullhornCRMARP", label = "BullhornCRM",uiConfig = "bullhorncrm-layout.json")
public class BullhornCRMConf extends AbstractArpConf<BullhornCRMConf> {
  private static final String ARP_FILENAME = "arp/implementation/bullhorncrm-arp.yaml";
  private static final ArpDialect ARP_DIALECT =
      AbstractArpConf.loadArpFile(ARP_FILENAME, (ArpDialect::new));
  private static final String DRIVER = "cdata.jdbc.bullhorncrm.BullhornCRMDriver";
